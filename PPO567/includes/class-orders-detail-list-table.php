...
class WPOrders_Detail_List_Table extends WP_List_Table {
    ...
    function prepare_items() {
        ...
        $this->ship_info = json_decode($ordersRow->ship_info);
        $this->total_amount = number_format($ordersRow->total_amount, 0, ',', '.');
        ...
        <table>
            <tr>
                ...
                <td><a href="user-edit.php?user_id={$this->customer_id}" target="_blank">#{$this->customer_id}</a></td>
            </tr>
            <tr>
                <td>Fullname:</td>
        ...
        <h3>Tổng thanh toán: <font color='red'>$this->total_amount</font> VNĐ</h3>
HTML;
    }
