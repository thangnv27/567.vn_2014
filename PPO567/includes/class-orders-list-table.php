                ...
                foreach ($columns as $column_name => $column_display_name) {
                    ...
                    switch ($column_name) {
                        ...
                        case "col_orders_id": echo '<td ' . $attributes . '>' . $rec->ID . '</td>';
                            break;
                        case "col_orders_customer_name": echo '<td ' . $attributes . '>' . $rec->display_name . '</td>';
                            break;
                        ...
                        case "col_orders_options":
                            if ($rec->status == UNAPPROVED) {
                                ...
                                echo '<td ' . $attributes . '><a href="' . $viewlink . '">View</a> | <a href="' . $approveLink . '">Approve</a> | <a href="' . $restoreLink . '">Restore</a>| <a onclick="return confirm(\'You are sure?\')" href="' . $deleteLink . '">Delete Permanently</a></td>';
                            }
                            break;
                    }
                }
    ...
    function get_bulk_actions() {
        ...
        if ($status == APPROVED) {
            ...
            $actions = array(
                ...
                'delete' => __('Delete Permanently', 'nvt_orders')
            );
        } else {
            $actions = array(
                'approve' => __('Approve', 'nvt_orders'),
