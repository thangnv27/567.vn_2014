        ...
        <form action="" method="post" id="frmOrder">
            ...
            <div class="cartCheckout">
                ...
                <div class="cartInfo">
                                    ...
                                    <tr id="product_item_<?php echo $product_id; ?>">
                                        <td class="cart-img">
                                            <a href="<?php echo $permalink; ?>" title="<?php echo $title; ?>">
                                                <img alt="<?php echo $title; ?>" src="<?php bloginfo('stylesheet_directory'); ?>/timthumb.php?src=<?php echo $product['thumb']; ?>&w=176&h=132" />
                                            </a>
                                            <div class="bold mt5 t_center t_red"><?php echo get_post_meta($product_id, "ma_sp", true); ?></div>
                                        </td>
                    ...
                    <p><a href="javascript://" id="btnMuaHang"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/btnGuiDonHang.png" alt="Send" /></a></p>
                </div>
            </div>
