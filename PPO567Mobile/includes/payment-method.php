...
$payment_fields = array(
    "payment_cashOnDelivery", "payment_atm", "payment_atOffice",
);
            ...
            <form method="post">
                <table class="form-table">
                   <tr>
                    ...
                    <tr>
                        <th><label for="payment_atm">Transfer via ATM</label></th>
                        <td>
                            <?php 
                   ...
                   <tr>
                        <th><label for="payment_atOffice">At Office</label></th>
                        <td>
                            <?php 
                            wp_editor(stripslashes(get_settings('payment_atOffice')), 'payment_atOffice', array(
                                'textarea_name' => 'payment_atOffice',
                            ));
                            ?>
                            <br />
                            <span class="description">Thanh toán tại văn phòng.</span>
                        </td>
                    </tr>
                </table>
                <div class="submit">
