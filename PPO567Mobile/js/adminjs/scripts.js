...
var CustomJS = function(){
    return {
        uploadSingleImage: function($){
            var fields = new Array("favicon", "sitelogo", "hotline", "ad_site_left", "ad_site_right", "ad_product_category", "bill_header", "logo_partner", "icon_giaohang", "icon_doihang", "icon_hoantien", "icon_dienthoai");
